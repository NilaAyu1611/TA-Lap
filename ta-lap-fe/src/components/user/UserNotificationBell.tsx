  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 bg-white transition hover:border-cyan-400 dark:border-white/10 dark:bg-white/5"
